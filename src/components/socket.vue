<template>
    <div id='socketBox'>
        <div class='socketTitle'>
            <img src='../images/tx.jpg' :class="{'imgGrayscale':imgGrayscale}">
            <span>我是誰</span>
...
export default {
    ...
    methods:{
        ...
        socket:function(){
            ...
            socket.emit('client1',this.value)
        ...
        inputFocus:function(){
            const socket = io(this.socketUrl)
            socket.emit('inputFocus1',this.value)
        },
        inputBlur:function(){
            const socket = io(this.socketUrl)
            socket.emit('inputBlur1',this.value)
        },
        socketJ:function(){
            const that = this;
            const socket = io(this.socketUrl);
